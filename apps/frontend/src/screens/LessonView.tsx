        ...
        <div className="flex justify-center min-h-screen pt-8">
            ...
            <div className="max-w-screen-xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
                        ...
                        <ChessBoard
                            ...
                            setBoard={(newBoard) => {
                                ...
                                if (lastMove && currentStep?.expectedMove) {
                                    if (lastMove.from === currentStep.expectedMove.from &&
                                        lastMove.to === currentStep.expectedMove.to) {
                ...
                <div className="order-1 md:order-2 bg-bgAuxiliary2 p-8 rounded-lg text-white">
                    ...
                    <p className="text-lg leading-relaxed text-gray-300 mb-6 min-h-[100px]">
                        {currentStep?.text}
                    </p>

                    {feedback && (
                        <div className={`p-4 rounded-md mb-6 ${feedback.includes("Incorrect") ? 'bg-red-900/50 text-red-200' : 'bg-green-900/50 text-green-200'}`}>
                            {feedback}
                        </div>
                    )}
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        {(!currentStep?.expectedMove || (feedback && !feedback.includes("Incorrect"))) && currentStepIndex < lesson.steps.length - 1 && (
                            <button
